...
import math
# from torchsummary import summary# 查看网络参数
...
# inputs = torch.rand([4, 16, 32, 16, 16])
# # 获取输入图像的通道数
# in_channel = inputs.shape[1]
# # 模型实例化
# model = eca_block(in_channel=in_channel).cuda()
# # 前向传播
# outputs = model(inputs.cuda())
#
# print(outputs.shape)  # 查看输出结果
# print(model)  # 查看网络结构
# summary(model, input_size=(16, 32, 16, 16), device='cuda')  # 查看网络参数
